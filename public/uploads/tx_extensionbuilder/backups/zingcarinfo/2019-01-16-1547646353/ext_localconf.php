...
call_user_func(
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig(
        'mod {
            wizards.newContentElement.wizardItems.plugins {
                elements {
                    ...
                    sellerinfo {
                        iconIdentifier = zingcarinfo-plugin-sellerinfo
                        title = LLL:EXT:zingcarinfo/Resources/Private/Language/locallang_db.xlf:tx_zingcarinfo_sellerinfo.name
                        description = LLL:EXT:zingcarinfo/Resources/Private/Language/locallang_db.xlf:tx_zingcarinfo_sellerinfo.description
                        tt_content_defValues {
                            CType = list
                            list_type = zingcarinfo_sellerinfo
                        }
                    }
                }
                show = *
		...
		$iconRegistry = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Core\Imaging\IconRegistry::class);
			...
			$iconRegistry->registerIcon(
				'zingcarinfo-plugin-sellerinfo',
				\TYPO3\CMS\Core\Imaging\IconProvider\SvgIconProvider::class,
				['source' => 'EXT:zingcarinfo/Resources/Public/Icons/user_plugin_sellerinfo.svg']
			);
