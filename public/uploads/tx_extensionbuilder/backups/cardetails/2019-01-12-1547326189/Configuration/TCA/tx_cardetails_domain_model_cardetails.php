...
return [
    ...
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, c_id, c_name, c_brand, color, price, fuel_type, seller, image, get_brand, get_c_name, get_fuel_type, get_price, get_seller_details',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, c_id, c_name, c_brand, color, price, fuel_type, seller, image, get_brand, get_c_name, get_fuel_type, get_price, get_seller_details, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'image' => [
            'exclude' => true,
            'label' => 'LLL:EXT:cardetails/Resources/Private/Language/locallang_db.xlf:tx_cardetails_domain_model_cardetails.image',
